...
Используется в:
- AI-Контент-Менеджер: генерация постов с настроением
...
# ═══════════════════════════════════════════════════════════════════
# КАТЕГОРИИ НАСТРОЕНИЙ (12 категорий x 4 интенсивности)
# ═══════════════════════════════════════════════════════════════════
...
PERSONA_CHARACTERISTICS = {
    "expert": {
        ...
        "temperature": 0.6  # Более стабильные ответы
    },
    ...
    "friend": {
        ...
        "temperature": 0.75  # Баланс тепла и стабильности
    },
    ...
    "rebel": {
        ...
        "temperature": 0.85  # Более креативные ответы
    },
    ...
    "philosopher": {
        ...
        "temperature": 0.8  # Глубина без хаоса
    },
    ...
    "tired": {
        ...
        "temperature": 0.65  # Честность без драматизма
    }
}
...
logger.info(f"[Mood Config] Загружено {TOTAL_EMOTIONS} эмоций в {len(MOOD_CATEGORIES)} категориях")
