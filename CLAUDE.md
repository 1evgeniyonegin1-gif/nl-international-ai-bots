...
### 🆕 Добавлено 23 января (ЗАДЕПЛОЕНО):
- **Воронки обновлены с реальными историями из базы знаний:**
  - Энергия — отзыв про Метабиотик
  - Иммунитет — отзыв про Биодрон
  - Красота — отзывы про коллаген и крем
  - Дети — история про дерматит + гель Smartum Max
  - Спорт — история Дмитрия-студента
  - Бизнес — история Елены из Екатеринбурга (45-55к/мес за 11 мес)
- **Очистка проекта:**
  - Удалено 18 файлов из корня
  - Архивировано 19 скриптов → scripts/archive/
  - Архивировано 12 документов → docs/archive/
  - Удалены неиспользуемые модули (gemini_client.py, scraper/)
