...
- **Система аналитики** (views, reactions, forwards, engagement rate)
- **Референсные изображения продуктов** (image-to-image через YandexART)
- **Композитинг изображений** (водяные знаки, логотипы)
- **Мониторинг каналов-образцов** (Telethon, требует API keys)

### 📋 TODO на завтра (21 января):
- [ ] **Деплой:** git pull + миграции БД + restart
- [ ] **Тестирование:** аналитика (/analytics, /top)
...
- Аналитика: не протестирована на реальных данных
