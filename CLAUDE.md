...
- RAG система (56 документов) с датированием
- Модерация постов (кнопки)
- Планирование публикаций
- **[NEW] Мониторинг каналов-образцов для стиля**
- **[NEW] Актуальность данных по датам в RAG**

### TODO:
- [ ] Доделать автопостинг (кнопки /schedule не все работают)
- [x] ~~Переписать промпты (анализ рынка + стайлгайд)~~ — добавлены образцы стиля
- [ ] Добавить статистику просмотров/реакций
- [ ] Настроить Telethon для мониторинга каналов
- [ ] Проставить даты во все документы KB
