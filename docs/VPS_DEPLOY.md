...
Type=simple
User=root
WorkingDirectory=/root/nl-international-ai-bots
Environment=PATH=/root/nl-international-ai-bots/venv/bin:/usr/bin
ExecStart=/root/nl-international-ai-bots/venv/bin/python run_bots.py
Restart=always
RestartSec=10
