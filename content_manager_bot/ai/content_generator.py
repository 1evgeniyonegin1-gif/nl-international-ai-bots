...
═══════════════════════════════════════════
⚠️ ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ К ПОСТУ:
═══════════════════════════════════════════

1. ФОРМАТИРОВАНИЕ:
   • Используй **жирный** для 2-3 ключевых слов
   • Используй *курсив* для мыслей/уточнений
   • Короткие абзацы (1-3 предложения)

2. ВОВЛЕЧЕНИЕ (ОБЯЗАТЕЛЬНО в конце!):
   • Задай вопрос: "Знакомо?", "А у тебя так было?"
   • ИЛИ попроси реакцию: "Ставь 🔥 если согласен"

3. ЮМОР/ИРОНИЯ (хотя бы 1 элемент):
   • Метафора или сравнение
   • Самоирония: "Спойлер: я тоже не сразу понял 😅"

4. РАЗГОВОРНЫЙ ЯЗЫК:
   • "щас", "норм", "ж" вместо "же"
   • Можно "блин", "фиг"

НЕ ПИШИ: сухие списки, официальный тон, банальности типа "Верь в себя!"
